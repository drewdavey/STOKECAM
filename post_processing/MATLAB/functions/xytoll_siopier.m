function [lat, lon] = xytoll_siopier(x, y)
%%Converts an array of local X,Y (meters) relative to an origin
%%and rotated to have the x-axis aligned with shore normal at SIO
%%to Lat, Lons.
%% B.Woodward  30,Aug,2006
%%%%%%%%  CONSTANTS  %%%%%%%%%
deg2rad = pi/180;
rad2deg = 180/pi;
OriginLat = (32 + 51/60. + 58.59779/3600.);
OriginLon = -1*(117 + 15/60. + 15.40493/3600.);
theta = 288; %shore-normal
%theta = 270 - 2.76; %shore-normal old pre-NCEX reference frame
ZoneNumber = 11;    %UTM zone for HB
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
